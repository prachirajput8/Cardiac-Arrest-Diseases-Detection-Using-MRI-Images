...
model = YOLO("C:\\Users\\ASUS\\Downloads\\yolocad\\model_project\\best.pt")
...
def predict_return(image):
    ...
    for box in results[0].boxes.xyxy:
        ...
        cv2.putText(orig_img_array, class_name, (xmin, ymin - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
